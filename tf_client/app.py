...
def __get_flask_server_params__():
    ...
    '''
    server_name = settings.get_env_var_setting('FLASK_SERVER_NAME', settings.DEFAULT_FLASK_SERVER_NAME)
    server_port = int(settings.get_env_var_setting('FLASK_SERVER_PORT', settings.DEFAULT_FLASK_SERVER_PORT))
    flask_debug = settings.get_env_var_setting('FLASK_DEBUG', settings.DEFAULT_FLASK_DEBUG)
